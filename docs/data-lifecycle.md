...
|---|---|---|---|
| HATP telemetry events | Node Hub (TimescaleDB) | Low — no content, hashed IDs | Yes |
...
```mermaid
graph TB
    subgraph L1 ["Level 1 · HATP GovernanceBlock · per-event declaration"]
...
*See also: [Security Model](./security.md) · [Key Lifecycle](./key-lifecycle.md) · [HATP Protocol](./protocol.md)*
